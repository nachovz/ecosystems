		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
				...
				<section class="post_content aplicacion-<?php the_ID(); ?>">
					...
					<a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'wp-apps-thumb' ); ?></a>
					...
					?>
					<br /><a href="<?php the_permalink() ?>" class="more" title="<?php the_title_attribute(); ?>">ver más</a>
